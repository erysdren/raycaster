...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[])
{
  ...
  textures[SMALL_BRICKS_TEXTURE] = SDL_LoadBMP("res/small_bricks.bmp");
  textures[LARGE_BRICKS_TEXTURE] = SDL_LoadBMP("res/large_bricks.bmp");
  textures[FLOOR_TEXTURE] = SDL_LoadBMP("res/floor.bmp");
  textures[CEILING_TEXTURE] = SDL_LoadBMP("res/ceiling.bmp");
  textures[WOOD_TEXTURE] = SDL_LoadBMP("res/wood.bmp");
  textures[SKY_TEXTURE] = SDL_LoadBMP("res/sky.bmp");
  textures[METAL_GRATING] = SDL_LoadBMP("res/grating.bmp");
  textures[METAL_BARS] = SDL_LoadBMP("res/bars.bmp");
  textures[GRASS_TEXTURE] = SDL_LoadBMP("res/grass.bmp");
  textures[DIRT_TEXTURE] = SDL_LoadBMP("res/dirt.bmp");
  textures[STONEWALL_TEXTURE] = SDL_LoadBMP("res/stonewall.bmp");
